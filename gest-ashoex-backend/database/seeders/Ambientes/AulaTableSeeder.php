...
class AulaTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('aula')->insert([
            ...
            ['numero_aula' => '202 B', 'capacidad' => 45, 'habilitada' => true, 'id_ubicacion' => 4, 'created_at' => now(), 'updated_at' => now()],
            ['numero_aula' => 'Labo 301', 'capacidad' => 20, 'habilitada' => true, 'id_ubicacion' => 5, 'created_at' => now(), 'updated_at' => now()],
            ['numero_aula' => 'Labo 302', 'capacidad' => 50, 'habilitada' => true, 'id_ubicacion' => 5, 'created_at' => now(), 'updated_at' => now()],
