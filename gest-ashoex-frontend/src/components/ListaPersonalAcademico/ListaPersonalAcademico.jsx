          ...
          <tbody>
            {listaPersonalAcademico.map((personal) => (
              <tr key={personal.personal_academico_id} className="fila-lista">
                ...
                <td>
                  <button onClick={() => handleEdit(personal)} className="btn btn-primary">Editar</button>
                  <button onClick={() => handleDelete(personal.personal_academico_id)} className="btn btn-danger">Eliminar</button>
                </td>
              </tr>
            ))}
          </tbody>
